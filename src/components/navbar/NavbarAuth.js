...
import { PromoteGraphLogo } from "components/icons/Icons";
  ...
  let brand = (
    <Link
      ...
      <Stack direction='row' spacing='12px' align='center' justify='center'>
        <PromoteGraphLogo h='26px' w='175px' color={logoColor} />
      </Stack>
  ...
  if (props.secondary === true) {
    brand = (
      <Link
        ...
        alignItems='center'
        color={mainText}>
        <PromoteGraphLogo h='26px' w='175px' my='32px' color={logoColor} />
      </Link>
    );
